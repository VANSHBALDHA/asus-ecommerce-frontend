...
const NonGstCompanyRegister = () => {
    ...
    const handlePANChange = (newPanNumber) => {
        let isValid = true;
        const panRegex = /^[A-Za-z]{5}[0-9]{4}[A-Za-z]{1}$/;
        if (!newPanNumber) {
            setPanNumberError('PAN number is required!');
            isValid = false;
        } else if (!panRegex.test(newPanNumber)) {
    ...
    const handleVerifyPanNumber = () => {
        ...
        if (!panNumber) {
            ...
            axios
                .get(
                    `https://sheet.gstincheck.co.in/check/96cae1a28964dad22bb0e2aeb8df0d6e/${panNumber}`
                )
                .then((res) => {
                    if (res?.data?.flag === true) {
                        ...
                        setCompanyNameNot('Pan card not verified');
                        setIsGSTVerified(true);
                        setGstSpinner(false);
                    }
                })
                        ...
                        <div className="ps-tab active" id="register">
                            <div className="gst_register_form_content">
                                ...
                                <div
                                    ...
                                    <input
                                        className={`form-control ${panNumberError && 'is-invalid'
                                            }`}
                                        name="panNumber"
                                        type="text"
...
export default NonGstCompanyRegister;
