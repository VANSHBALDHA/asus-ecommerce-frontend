...
const CorporateCompanyRegister = () => {
                    ...
                    <div className="ps-form--account gst_register_form_field">
                        <div className="ps-tab active" id="register">
                            <div className="gst_register_form_content">
                                ...
                                <label className="form-label" htmlFor="register-as" style={{ marginBottom: "10px" }}>
                                    Register as
                                </label>
                                <div className="form-group">
                                    <Radio.Group onChange={onRadioChange} value={radioValue}>
                                        ...
                                        <Radio value={3}>Technician</Radio>
                                    </Radio.Group>
                                </div>
...
export default CorporateCompanyRegister;
